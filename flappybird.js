...
function moverPassaro(evento) {
    // Verifica se a tecla pressionada é a barra de espaço, seta para cima ou tecla X ou toque na tela
...
function atualizar() {
    ...
    if (jogoEncerrado) {
        ...
        contexto.fillText("Você conseguiu R$ " + valorAposta, 65, alturaTabuleiro/2 + 50);
    ...
    contexto.fillText("Saldo: R$ " + valorAposta, 10, 70)
}
Luis
